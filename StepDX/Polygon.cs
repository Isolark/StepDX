...
namespace StepDX
{
    public class Polygon
    {
        ...
        public bool Deleted { set { deleted = value; } get { return deleted; } }

        private int points = 5;
        public int Points { set { points = value; } get { return points; } }

        private float vy = 0;
        public float Vy { set { vy = value; } get { return vy; } }

        private float rightedge = 0;
        public float Rightedge { set { rightedge = value; } get { return rightedge; } }

        private float leftedge = 0;
        public float Leftedge { set { leftedge = value; } get { return leftedge; } }
        /// <summary>
        /// The raw vertex values we are supplied
        /// </summary>
        protected List<Vector2> verticesB = new List<Vector2>();
        protected List<Vector2> verticesB2 = new List<Vector2>();
        /// <summary>
